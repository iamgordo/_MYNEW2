...
function start() {
    ...
    ground1 = new ground("mountain",900,330,498,277,-0.6);
    ground2 = new ground("mountain",1300,360,498,277,-0.6);
    ground3 = new ground("mountain",1600,320,498,277,-0.6);
    ground4 = new ground("mountain",2100,310,498,277,-0.6);
...
// image loader make new function to contain all image loading
// var image = new Image();
    ...
    for (let i = 0; i < biplanes.length; i++) {
        ...
        for (let j = 0; j < bullets.length; j++) {
            ...
            if (checkCollision(thisslug, thisbiplane)) {
                ...
                explosion1 = new explosion(canvasContext,biplanes[i].x - 90,biplanes[i].y - 94,256,256,8,8);
...
function recycle_enemy(itema) {
    if (itema.y + itema.height > canvas.height) {
...
function timesup() {
    wavechange = false;
    if (wave === 3) {
        oneenemy = new enemy("biplane",800,200,73,37,-6,0);
        twoenemy = new enemy("biplane",1200,400,73,37,-6,0);
        threeenemy = new enemy("biplane",1400,600,73,37,-6,0);
        fourenemy = new enemy("biplane",1600,200,73,37,-6,0);
    }
    // draw new wave
}
function draw() {
